...
public class FragmentINIC extends Fragment {
    ...
    private static final Long INIC = 1L;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tipos_carga_inic, container, false);

        hojaRutaId = getArguments().getLong("id");
        chofer = getArguments().getString("chofer");

        carga = (Carga) getArguments().getSerializable("cargaINIC");
